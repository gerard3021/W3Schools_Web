...
<form action="<?= base_url('orders/store') ?>" method="post">
    ...
    <div class="campo"><label>Fecha de Orden:*</label><input type="date" name="OrderDate" value="<?= esc($old['OrderDate'] ?? date('Y-m-d')) ?>" required></div>
    ...
    <br><input type="submit" value="Registrar">&nbsp;<a href="<?= base_url('orders') ?>" class="btn btn-gray">Cancelar</a>
</form>
