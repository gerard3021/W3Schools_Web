...
<form action="<?= base_url('products/store') ?>" method="post">
    ...
    <div class="campo"><label>Unidad: *</label><input type="text" name="Unit" value="<?= esc($old['Unit'] ?? '') ?>" required></div>
    <div class="campo"><label>Precio: *</label><input type="number" name="Price" step="0.01" min="0.01" value="<?= esc($old['Price'] ?? '') ?>" required></div>
