...
ALTER TABLE employees MODIFY EmployeeID int NOT NULL AUTO_INCREMENT;
ALTER TABLE shippers MODIFY ShipperID int NOT NULL AUTO_INCREMENT;
ALTER TABLE suppliers MODIFY SupplierID int NOT NULL AUTO_INCREMENT;
...
ALTER TABLE order_details MODIFY OrderDetailID int NOT NULL AUTO_INCREMENT;
